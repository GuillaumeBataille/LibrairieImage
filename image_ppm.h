...
/*===========================================================================*/
void ecrire_image_ppm(std::string nom_image, OCTET *pt_image, int nb_lignes, int nb_colonnes)
{
    FILE *f_image;
    int taille_image = 3 * nb_colonnes * nb_lignes;

    if ((f_image = fopen(nom_image.c_str(), "wb")) == NULL)
    {
...
/*===========================================================================*/
void lire_nb_lignes_colonnes_image_ppm(std::string nom_image, int *nb_lignes, int *nb_colonnes)
{
    FILE *f_image;
    int max_grey_val;
    ...
    if ((f_image = fopen(nom_image.c_str(), "rb")) == NULL)
    {
...
/*===========================================================================*/
/*===========================================================================*/
void lire_image_ppm(std::string nom_image, OCTET *pt_image, int taille_image)
{
    FILE *f_image;
...
void ecrire_image_pgm(std::string nom_image, OCTET *pt_image, int nb_lignes, int nb_colonnes)
{
    FILE *f_image;
...
void lire_nb_lignes_colonnes_image_pgm(std::string nom_image, int *nb_lignes, int *nb_colonnes)
{
    FILE *f_image;
    int max_grey_val;
...
/*===========================================================================*/
/*===========================================================================*/
void lire_image_pgm(std::string nom_image, OCTET *pt_image, int taille_image)
{
    FILE *f_image;
    int nb_colonnes, nb_lignes, max_grey_val;
